...
class Aggregator(aggregator.Aggregator):
    ...
    def get_data(self):
        """
        Perform the requests to retrieve the content available on amazon.
        :return: Dictionary containing values for a movie model
        """
        skip = 0
        base_url = 'https://api.reelgood.com/v2/browse/source/amazon'
        params = {
